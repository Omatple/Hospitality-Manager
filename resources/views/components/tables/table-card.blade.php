...
<div onclick="window.location.href='{{ route('orders.create.selectUser', $table) }}'"
    class="cursor-pointer table-card bg-{{ $table->status === 'available' ? 'green' : 'red' }}-500 text-white rounded-lg shadow-lg flex flex-col justify-center items-center pb-6 w-full h-full">
