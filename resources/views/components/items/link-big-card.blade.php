...
@endphp
<a href="{{ $url }}"
    class="cursor-pointer group relative block w-full max-w-sm h-64 mx-auto bg-gradient-to-r from-blue-500 to-green-500 rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">
